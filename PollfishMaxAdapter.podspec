Pod::Spec.new do |s|
    ...
    s.description           = 'Adapter for publishers looking to use Max mediation to load and show Rewarded Surveys from Pollfish in the same waterfall with other Rewarded Ads.'
    ...
    s.dependencies          = { 'Pollfish'=> "~> 6.2.3", 'AppLovinSDK'=> '>= 11.1.1'}
